...
// Epeidi den mporousa na katalavw pws douleuei h parakatw tou mpampi,
// tin ksanaegrapsa opws sto decode kommati pio prin
...
*/
	...
	uint8_t MEMWB_getDestRegRD() { return (uint8_t) (regs[MEM_WB][3] >> 8 ); }
	uint8_t MEMWB_getDestRegRT() { return (uint8_t) (regs[MEM_WB][3] && 0xff ); }
